import {
  Ruler, Target, Trophy, ClipboardList, Zap,
} from 'lucide-react'
...
export const testimonials = [
  ...
  { initials: 'MN', name: 'Minal',    meta: 'GCSE Mathematics',   stars: 5, text: 'I had only a few lessons with Ather leading up to my GCSEs and the difference was amazing. He increased my confidence and I achieved a grade 9 (A**). I will definitely be taking more lessons for A-level maths!' },
  ...
  { initials: 'AK', name: 'Aadam',    meta: 'IB Math AA HL',      stars: 5, text: 'Ather sir is a great teacher of Mathematics. For anyone who wants to study IB HL mathematics, I definitely recommend him! I received a 7 in Math AA HL for 2025 Examinations, thanks to his great support.' },
...
export const whyFeatures = [
  ...
  { Icon: ClipboardList, title: 'Covers Key Mathematics Syllabuses', desc: 'IB Mathematics (AA & AI), AP Calculus, and SAT Math — all expertly covered.' },
